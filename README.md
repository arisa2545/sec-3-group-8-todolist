...
3. List ที่เเสดง สิ่งที่เเสดงประกอบด้วย
   ...
   * คําอธิบายของ list 
   * Important ของ list
   * Edit ของ list (สามารถเเก้ไขรายละเอียดต่างๆได้)
...
4. สามารถเพิ่มรายการที่ต้องทําได้โดย
   ...
   * เลือกติ๊กว่าlistอยู่ในหมวดimportantหรือไม่ โดยสามารถกดที่สัญลักษณ์bookmarkในภายหลัง เพื่อให้รายการนั้น อยู่ในหมวด important ได้ โดยที่ important เป็นหนึ่งในหมวดที่     มีมาให้ตั้งแต่แรกอยู่แล้ว
